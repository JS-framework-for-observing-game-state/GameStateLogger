...
class Ghost {
  ...
  setSpriteSheet(name, direction, mode) {
    ...
    if (mode === 'scared') {
      this.animationTarget.style.backgroundImage = 'url(styles/graphics/'
...
class Pacman {
  ...
  reset() {
    ...
    this.pacmanArrow.style.backgroundImage = 'url(styles/graphics/'
  ...
  prepDeathAnimation() {
    ...
    this.animationTarget.style.backgroundSize = `${bgSize}px`;
    this.animationTarget.style.backgroundImage = 'url(styles/'
...
class GameCoordinator {
  ...
  preloadAssets() {
    return new Promise((resolve) => {
      ...
      const imgBase = 'styles/graphics/spriteSheets/';
      const imgSources = [
        // Pacman
        ...
        // Misc
        'styles/graphics/extra_life.svg',
      ];

      const audioBase = 'styles/audio/';
      const audioSources = [
  ...
  updateExtraLivesDisplay() {
    ...
    for (let i = 0; i < this.lives; i += 1) {
      ...
      extraLifePic.setAttribute('src', 'styles/graphics/extra_life.svg');
  ...
  advanceLevel() {
    ...
    const imgBase = 'styles//graphics/spriteSheets/maze/';
  ...
  displayText(position, amount, duration, width, height) {
    ...
    pointsDiv.style.backgroundImage = 'url(styles/graphics/'
...
class Pickup {
  ...
  determineImage(type, points) {
    ...
    return `url(styles/graphics/spriteSheets/pickups/${image}.svg)`;
  }
